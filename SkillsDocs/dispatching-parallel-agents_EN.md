# ⚙️ dispatching-parallel-agents — User Guide (English)
...
**dispatching-parallel-agents** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\dispatching-parallel-agents\
...
`C:\Users\User\.copilot\skills\dispatching-parallel-agents\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · dispatching-parallel-agents · v1.0*
