# ⚙️ subagent-driven-development — User Guide (English)
...
**subagent-driven-development** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\subagent-driven-development\
├── code-quality-reviewer-prompt.md ← Helper script
├── implementer-prompt.md ← Helper script
├── SKILL.md             ← Skill definition and rules
├── spec-reviewer-prompt.md ← Helper script
```
...
`C:\Users\User\.copilot\skills\subagent-driven-development\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · subagent-driven-development · v1.0*
