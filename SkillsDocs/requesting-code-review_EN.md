# ⚙️ requesting-code-review — User Guide (English)
...
**requesting-code-review** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\requesting-code-review\
├── code-reviewer.md     ← Helper script
...
`C:\Users\User\.copilot\skills\requesting-code-review\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · requesting-code-review · v1.0*
