...
**always-ask-next** 是安裝在此環境中的 GitHub Copilot CLI skill。
...
**Q：如何安裝這個 Skill？**
A：將 `SKILL.md` 放到 `C:\Users\User\.copilot\skills\always-ask-next\` 即可。下次啟動 Agent session 時會自動載入。
