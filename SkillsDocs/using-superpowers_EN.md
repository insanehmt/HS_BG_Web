# ⚙️ using-superpowers — User Guide (English)
...
**using-superpowers** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\using-superpowers\
...
`C:\Users\User\.copilot\skills\using-superpowers\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · using-superpowers · v1.0*
