# ⚙️ writing-plans — User Guide (English)
...
**writing-plans** is a GitHub Copilot CLI skill installed in this environment.
...
├── plan-document-reviewer-prompt.md ← Helper script
...
`C:\Users\User\.copilot\skills\writing-plans\`. It loads automatically on next session.
