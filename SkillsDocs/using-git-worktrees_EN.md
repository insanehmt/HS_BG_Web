# ⚙️ using-git-worktrees — User Guide (English)
...
**using-git-worktrees** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\using-git-worktrees\
...
`C:\Users\User\.copilot\skills\using-git-worktrees\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · using-git-worktrees · v1.0*
