# ⚙️ receiving-code-review — User Guide (English)
...
**receiving-code-review** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\receiving-code-review\
...
`C:\Users\User\.copilot\skills\receiving-code-review\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · receiving-code-review · v1.0*
