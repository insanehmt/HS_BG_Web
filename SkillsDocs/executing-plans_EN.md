# ⚙️ executing-plans — User Guide (English)
...
**executing-plans** is a GitHub Copilot CLI skill installed in this environment.
...
```
C:\Users\User\.copilot\skills\executing-plans\
...
`C:\Users\User\.copilot\skills\executing-plans\`. It loads automatically on next session.
...
*GitHub Copilot CLI Skill · executing-plans · v1.0*
